...
$(document).ready(function (e) {
  var baseURL = window.sessionStorage.getItem("address");
  ...
  qr_creator__WEBPACK_IMPORTED_MODULE_0__["default"].render({
    ...
    background: '#ffffff',
    size: 128
  }, document.querySelector('#qr-code')); // $("#user-email").text(JSON.parse(window.sessionStorage.getItem("user"))["email"]);
