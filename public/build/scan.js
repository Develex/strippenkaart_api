...
$(document).ready(function (e) {
  ...
  $("#findUser").submit(function (e) {
    ...
    fetch(baseURL + "/api/v1/stripcard/" + window.sessionStorage.getItem("id"), {
      ...
      body: JSON.stringify({
        "change": $('select[name="userAmount"]').val()
      })
    }).then(function (response) {
      $("#errorMessage").hide();
      $("#successMessage").hide();
